...
/*
MsgYesNo(Message, Title, RevertDefault, nIcon, lSysModal, lTopMost) --> logical
*/
...
/*
MsgYesNoCancel(Message, Title, nIcon, lSysModal, nDefaultButton, lTopMost) --> numeric
*/
...
/*
MsgRetryCancel(Message, Title, nIcon, lSysModal, nDefaultButton, lTopMost) --> logical
*/
...
/*
MsgOkCancel(Message, Title, nIcon, lSysModal, nDefaultButton, lTopMost) --> logical
*/
...
/*
MsgExclamation(Message, Title, nIcon, lSysModal, lTopMost) --> numeric
*/
...
/*
MsgInfo(Message, Title, nIcon, lSysModal, lTopMost) --> numeric
*/
...
/*
MsgStop(Message, Title, nIcon, lSysModal, lTopMost) --> numeric
*/
...
/*
MsgBox(Message, Title, lSysModal, lTopMost) --> numeric
*/
