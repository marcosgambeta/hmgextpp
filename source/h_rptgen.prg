...
PROCEDURE ExecuteReport(cReportName, lPreview, lSelect, cOutputFileName)
   ...
   IF !_HMG_RPTDATA[150] .AND. !_HMG_RPTDATA[163]
      ...
      IF lPreview
         ...
         ELSE
            SELECT PRINTER cPrinter TO lSuccess ORIENTATION nOrientation PAPERSIZE nPaperSize PREVIEW
         ENDIF

      ELSE

         IF nPaperSize == PRINTER_PAPER_USER
            SELECT PRINTER cPrinter TO lSuccess ORIENTATION nOrientation PAPERSIZE nPaperSize PAPERWIDTH nPaperWidth PAPERLENGTH nPaperHeight
         ELSE
            SELECT PRINTER cPrinter TO lSuccess ORIENTATION nOrientation PAPERSIZE nPaperSize
         ENDIF
