...
HB_FUNC(HMG_INITTOOLBUTTON)
{
  ...
  if (hb_parclen(8) > 0)
  {
    auto tSize = static_cast<DWORD>(SendMessage(hwndTB, TB_GETPADDING, 0, 0));
    int px = LOWORD(tSize);
    int py = HIWORD(tSize);
    auto ix = 0;
    auto iy = 0;
  ...
  auto nPoz = static_cast<int>(SendMessage(hwndTB, TB_ADDBITMAP, 1, reinterpret_cast<LPARAM>(&tbab)));
  ...
  if (hb_parclen(2) > 0)
  {
    ...
    auto index = static_cast<int>(SendMessage(hwndTB, TB_ADDSTRING, 0, reinterpret_cast<LPARAM>(lpText)));
...
HB_FUNC(HMG_INITTOOLBAREX)
{
  ...
  {
    SendMessage(hwndTB, TB_SETBUTTONSIZE, hb_parni(6), hb_parni(7));
    auto nPadd = static_cast<DWORD>(SendMessage(hwndTB, TB_GETPADDING, 0, 0));
...
HB_FUNC(HMG_INITTOOLBUTTONEX)
{
  ...
  auto ix = 0;
  auto iy = 0;
  auto xBtn = static_cast<int>(SendMessage(hwndTB, TB_BUTTONCOUNT, 0, 0));
  auto TbStyle = static_cast<DWORD>(SendMessage(hwndTB, TB_GETSTYLE, 0, 0));
  int style = TBSTYLE_BUTTON;
...
HB_FUNC(HMG_CREATEPOPUPCHEVRON)
{
  ...
  auto nBtn = static_cast<int>(SendMessage(tbHwnd, TB_BUTTONCOUNT, 0, 0));
...
HB_FUNC(HMG_ADJUSTFLOATTOOLBAR)
{
  ...
  auto nbuttons = static_cast<int>(SendMessage(hwndTB, TB_BUTTONCOUNT, 0, 0));
  int height =
