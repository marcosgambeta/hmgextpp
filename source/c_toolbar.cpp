...
HB_FUNC(HMG_INITTOOLBUTTON)
{
  ...
  if (hb_parclen(8) > 0)
  {
    DWORD tSize = static_cast<DWORD>(SendMessage(hwndTB, TB_GETPADDING, 0, 0));
    int px = LOWORD(tSize);
    int py = HIWORD(tSize);
    auto ix = 0;
    auto iy = 0;
  ...
  int nPoz = static_cast<int>(SendMessage(hwndTB, TB_ADDBITMAP, 1, reinterpret_cast<LPARAM>(&tbab)));
  ...
  if (hb_parclen(2) > 0)
  {
    ...
    int index = static_cast<int>(SendMessage(hwndTB, TB_ADDSTRING, 0, reinterpret_cast<LPARAM>(lpText)));
  ...
  tbb[nBtn].fsStyle = static_cast<BYTE>(style);
  nBtn++;
...
HB_FUNC(HMG_INITTOOLBAREX)
{
  ...
  {
    SendMessage(hwndTB, TB_SETBUTTONSIZE, hb_parni(6), hb_parni(7));
    DWORD nPadd = static_cast<DWORD>(SendMessage(hwndTB, TB_GETPADDING, 0, 0));
...
HB_FUNC(HMG_INITTOOLBUTTONEX)
{
  ...
  auto ix = 0;
  auto iy = 0;
  int xBtn = static_cast<int>(SendMessage(hwndTB, TB_BUTTONCOUNT, 0, 0));
  DWORD TbStyle = static_cast<DWORD>(SendMessage(hwndTB, TB_GETSTYLE, 0, 0));
  int style = TBSTYLE_BUTTON;
  ...
  if (hb_parclen(2))
  {
    void *str;
    LPCTSTR lpText = HB_PARSTR(2, &str, nullptr);
    index = static_cast<int>(SendMessage(hwndTB, TB_ADDSTRING, 0, reinterpret_cast<LPARAM>(lpText)));
    tbb[nBtn].iString = index;
    style |= BTNS_SHOWTEXT;
    hb_strfree(str);
  ...
  tSize = static_cast<DWORD>(SendMessage(hwndTB, TB_GETPADDING, 0, 0));
  int px = LOWORD(tSize);
  int py = HIWORD(tSize);
  ...
  if (hb_parni(17) > -1)
  {
    if (xBtn == 0)
    {
      ...
      {
        SendMessage(hwndTB, TB_SETIMAGELIST, 0,
                    reinterpret_cast<LPARAM>(hmg_par_HIMAGELIST(18))); // TODO: revisar
        if (hb_parni(19))
        {
          SendMessage(hwndTB, TB_SETHOTIMAGELIST, 0,
                      reinterpret_cast<LPARAM>(hmg_par_HIMAGELIST(19))); // TODO: revisar
        }
...
HB_FUNC(HMG_GETSIZETOOLBAR)
{
  ...
  int nBtn = static_cast<int>(SendMessage(hwndTB, TB_BUTTONCOUNT, 0, 0));
  TBBUTTON lpBtn;
...
HB_FUNC(HMG_MAXTEXTBTNTOOLBAR)
{
  ...
  {
    DWORD style = static_cast<DWORD>(SendMessage(hwndTB, TB_GETSTYLE, 0, 0));
...
HB_FUNC(HMG_CREATEPOPUPCHEVRON)
{
  ...
  int nBtn = static_cast<int>(SendMessage(tbHwnd, TB_BUTTONCOUNT, 0, 0));
...
HB_FUNC(HMG_ADJUSTFLOATTOOLBAR)
{
  ...
  int nbuttons = static_cast<int>(SendMessage(hwndTB, TB_BUTTONCOUNT, 0, 0));
  int height =
...
int ResizeToolbar(HWND hwndTB, int widthTb) // TODO: revisar (porque passar parâmetros se os valores
                                            // passados não são utilizados ?)
{
...
HB_FUNC(HMG_TOOLBAREXCUSTFUNC)
{
  ...
  case WM_NOTIFY: {
    ...
    case TBN_RESET: {
      int nCount = static_cast<int>(SendMessage(lpTB->hdr.hwndFrom, TB_BUTTONCOUNT, 0, 0));
...
HB_FUNC_TRANSLATE(INITTOOLBAR, HMG_INITTOOLBAR)
HB_FUNC_TRANSLATE(INITTOOLBUTTON, HMG_INITTOOLBUTTON)
HB_FUNC_TRANSLATE(INITTOOLBAREX, HMG_INITTOOLBAREX)
HB_FUNC_TRANSLATE(INITTOOLBUTTONEX, HMG_INITTOOLBUTTONEX)
HB_FUNC_TRANSLATE(GETSIZETOOLBAR, HMG_GETSIZETOOLBAR)
HB_FUNC_TRANSLATE(MAXTEXTBTNTOOLBAR, HMG_MAXTEXTBTNTOOLBAR)
HB_FUNC_TRANSLATE(ISBUTTONBARCHECKED, HMG_ISBUTTONBARCHECKED)
HB_FUNC_TRANSLATE(CHECKBUTTONBAR, HMG_CHECKBUTTONBAR)
HB_FUNC_TRANSLATE(ISBUTTONENABLED, HMG_ISBUTTONENABLED)
HB_FUNC_TRANSLATE(GETBUTTONBARRECT, HMG_GETBUTTONBARRECT)
HB_FUNC_TRANSLATE(GETBUTTONPOS, HMG_GETBUTTONPOS)
HB_FUNC_TRANSLATE(SETBUTTONTIP, HMG_SETBUTTONTIP)
HB_FUNC_TRANSLATE(SETTOOLBUTTONCAPTION, HMG_SETTOOLBUTTONCAPTION)
HB_FUNC_TRANSLATE(SETTOOLBUTTONIMAGE, HMG_SETTOOLBUTTONIMAGE)
HB_FUNC_TRANSLATE(REPLACETOOLBUTTONIMAGE, HMG_REPLACETOOLBUTTONIMAGE)
HB_FUNC_TRANSLATE(SETROWSBUTTON, HMG_SETROWSBUTTON)
HB_FUNC_TRANSLATE(RESIZESPLITBOXITEM, HMG_RESIZESPLITBOXITEM)
HB_FUNC_TRANSLATE(SETCHEVRONSTYLESPLITBOXITEM, HMG_SETCHEVRONSTYLESPLITBOXITEM)
HB_FUNC_TRANSLATE(SETCAPTIONSPLITBOXITEM, HMG_SETCAPTIONSPLITBOXITEM)
HB_FUNC_TRANSLATE(CREATEPOPUPCHEVRON, HMG_CREATEPOPUPCHEVRON)
HB_FUNC_TRANSLATE(GETBUTTONBAR, HMG_GETBUTTONBAR)
HB_FUNC_TRANSLATE(GETIMAGELIST, HMG_GETIMAGELIST)
HB_FUNC_TRANSLATE(SETCHEVRONIMAGE, HMG_SETCHEVRONIMAGE)
HB_FUNC_TRANSLATE(DESTROYMENU, HMG_DESTROYMENU)
HB_FUNC_TRANSLATE(ADJUSTFLOATTOOLBAR, HMG_ADJUSTFLOATTOOLBAR)
HB_FUNC_TRANSLATE(RESIZEFLOATTOOLBAR, HMG_RESIZEFLOATTOOLBAR)
HB_FUNC_TRANSLATE(TOOLBAREXCUSTFUNC, HMG_TOOLBAREXCUSTFUNC)
#endif
