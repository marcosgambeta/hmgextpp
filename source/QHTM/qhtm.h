...
//        Set resReturnValue to FALSE to prevent QHTM from starting the user agent associated with
//        the link. This would be used if you had encoded some of your own links to internal
//        functions in the HTML
...
//        ::SendMessage( hwnd, QHTM_SET_OPTION, QHTM_OPT_SET_BITMAP_CALLBACK,
//        (LPARAM)MyBitmapCallback ); Set the function to call for bitmap loading
#define QHTM_OPT_SET_BITMAP_CALLBACK (7)

//        ::SendMessage( hwnd, QHTM_SET_OPTION, QHTM_OPT_SET_RESOURCE_CALLBACK,
//        (LPARAM)MyResourceCallback ); Set the function to call for resource loading
#define QHTM_OPT_SET_RESOURCE_CALLBACK (8)

//        ::SendMessage( hwnd, QHTM_SET_OPTION, QHTM_OPT_SET_FORM_SUBMIT_CALLBACK,
//        (LPARAM)MyFormSubmitCallback ); Set the function to call when submitting a form via POST
#define QHTM_OPT_SET_FORM_SUBMIT_CALLBACK (9)

//        ::SendMessage( hwnd, QHTM_SET_OPTION, QHTM_OPT_SET_ALWAYS_SHOW_TIPS,
//        (LPARAM)bAlwaysShowTips ); Set whether tips are show even when the window is not the
//        active one
