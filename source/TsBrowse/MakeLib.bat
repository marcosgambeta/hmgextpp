...
:BUILD
  ...
  %MV_HRB%\bin\harbour h_controlmisc2.prg -n1 -w2 -gc0 -i%MV_HRB%\include;%MG_ROOT%\include

  %MG_BCC%\bin\bcc32 -c -O2 -tWM -d -6 -OS -I%MV_HRB%\include;%MG_BCC%\include;%MG_ROOT%\include -L%MV_HRB%\lib;%MG_BCC%\lib c_tbrowse.c h_tbrowse.c TControl.c TSColumn.c scrllbar.c SbMsg.c c_controlmisc1.c h_controlmisc1.c h_controlmisc2.c TComboBox.c TDatePicker.c TBtnBox.c TGetBox.c TSMulti.c TCursor.c
  %MG_BCC%\bin\tlib %MV_BUILD%\tsbrowse.lib +c_tbrowse.obj +h_tbrowse.obj +TControl.obj +TSColumn.obj +scrllbar.obj +SbMsg.obj +c_controlmisc1.obj +h_controlmisc1.obj +h_controlmisc2.obj +TComboBox.obj +TDatePicker.obj +TBtnBox.obj +TGetBox.obj +TSMulti.obj +TCursor.obj
...
:CLEANUP
  ...
  if exist h_controlmisc2.c del h_controlmisc2.c
