...
FUNCTION LoadMsg()
   ...
   LOCAL aMsg
   LOCAL cLang := Upper(Left(Set(_SET_LANGUAGE), 2))
   LOCAL aProper
   ...
   aMsg := { "Yes", ;                   // ::aMsg[1]
          ...
          "Print", ;                 // ::aMsg[44]
          "Exit", ;                  // ::aMsg[45]
          "Restore Record ?", ;      // ::aMsg[46]
          "", ;    // ::aMsg[47]      (future possible usage)
          "", ;    // ::aMsg[48]
          "", ;    // ::aMsg[49]
          "" }     // ::aMsg[50]
...
*/
         ...
         aMsg := { "Oui", ;                                    // ::aMsg[1]
                   ...
                   "Copie", ;   // ::aMsg[44]
                   "Sortie", ;  // ::aMsg[45]
                   "Reconstituer ?", ;    // ::aMsg[46] (future possible usage)
                   "", ;    // ::aMsg[47]
                   "", ;    // ::aMsg[48]
                   "", ;    // ::aMsg[49]
                   "" }     // ::aMsg[50]
...
*/
         ...
         aMsg :=    { "Ja", ;                                                      // ::aMsg[ 1]
                      ...
                      "Druck", ;      // ::aMsg[44]
                      "Ausgang", ;    // ::aMsg[45]
                      "Datensatz wiederherstellen ?", ;    // ::aMsg[46] (future possible usage)
                      "", ;    // ::aMsg[47]
                      "", ;    // ::aMsg[48]
                      "", ;    // ::aMsg[49]
                      "" }     // ::aMsg[50]
...
*/
         ...
         aMsg := { "Si", ;                    // ::aMsg[1]
                   ...
                   "Stampa", ;    // ::aMsg[44]
                   "Uscita", ;    // ::aMsg[45]
                   "Ripristina il Record ?", ;    // ::aMsg[46] (future possible usage)
                   "", ;    // ::aMsg[47]
                   "", ;    // ::aMsg[48]
                   "", ;    // ::aMsg[49]
                   "" }     // ::aMsg[50]
...
*/
         aMsg := { "Tak", ;                   // ::aMsg[1]
                   ...
                   "Drukuj", ;                // ::aMsg[44]
                   "Wyjњcie", ;               // ::aMsg[45]
                   "Przywrуж rekord ?", ;     // ::aMsg[46] (future possible usage)
                   "", ;    // ::aMsg[47]
                   "", ;    // ::aMsg[48]
                   "", ;    // ::aMsg[49]
                   "" }     // ::aMsg[50]
...
*/
         ...
         aMsg := { "Sim", ;                   // ::aMsg[1]
                   ...
                   "Copia", ;    // ::aMsg[44]
                   "Saida", ;    // ::aMsg[45]
                   "Restaurar Registro ?", ;    // ::aMsg[46] ( para uso futuro )
                   "", ;    // ::aMsg[47]
                   "", ;    // ::aMsg[48]
                   "", ;    // ::aMsg[49]
                   "" }     // ::aMsg[50]
...
/*
   ISO Name...: Russian
   Translator.: Grigory Filatov <gfilatov@gmail.com>
   Country....: Ukraine
...
*/
         ...
         aMsg := { "Да", ;                    // ::aMsg[1]
                   ...
                   "Печать", ;                // ::aMsg[44]
                   "Выход", ;                 // ::aMsg[45]
                   "Восстановить запись ?", ; // ::aMsg[46] (future possible usage)
                   "", ;    // ::aMsg[47]
                   "", ;    // ::aMsg[48]
                   "", ;    // ::aMsg[49]
                   "" }     // ::aMsg[50]
...
*/
         ...
         aMsg := { "Так", ;                   // ::aMsg[1]
                   ...
                   "Друк", ;                  // ::aMsg[44]
                   "Вихiд", ;                 // ::aMsg[45]
                   "Відновити запис ?", ;     // ::aMsg[46] (future possible usage)
                   "", ;    // ::aMsg[47]
                   "", ;    // ::aMsg[48]
                   "", ;    // ::aMsg[49]
                   "" }     // ::aMsg[50]
...
*/
         ...
         aMsg := { "Si", ;                    // ::aMsg[1]
                   ...
                   "Imprimir", ;               // ::aMsg[44]
                   "Salir", ;                  // ::aMsg[45]
                   "Ё Restaurar Registro ?", ; // ::aMsg[46] (para un posible uso futuro)
                   "", ;    // ::aMsg[47]
                   "", ;    // ::aMsg[48]
                   "", ;    // ::aMsg[49]
                   "" }     // ::aMsg[50]
...
*/
         ...
         aMsg := { "Ja", ;                     // ::aMsg[1]
                   ...
                   "Druk", ;                   // ::aMsg[44]
                   "Uitgang", ;                // ::aMsg[45]
                   "Herstellen record ?", ;    // ::aMsg[46] (future possible usage)
                   "", ;    // ::aMsg[47]
                   "", ;    // ::aMsg[48]
                   "", ;    // ::aMsg[49]
                   "" }     // ::aMsg[50]
