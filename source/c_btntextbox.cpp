...
HB_FUNC( INITBTNTEXTBOX )
{
   ...
   int  BtnWidth2;
   int  BtnWidth = ( HB_ISNIL(18) ? 0 : hmg_par_int(18) );
...
HB_FUNC( REDEFBTNTEXTBOX )
{
   ...
   int  BtnWidth = ( HB_ISNIL(3) ? 0 : hmg_par_int(3) );
   ...
   if( !( hb_parc(2) == nullptr ) )
   {
      ...
      if( himage != nullptr )
      {
         ...
         if( bm.bmWidth > BtnWidth - 4 || bm.bmHeight > height - 5 )
         {
            ...
            if( himage == nullptr )
            {
               himage = ( HWND ) LoadImage(nullptr, lpImageName, IMAGE_BITMAP, BtnWidth - 4, height - 6, LR_LOADFROMFILE | LR_LOADMAP3DCOLORS | LR_LOADTRANSPARENT);
            }
         }
      }
#ifdef UNICODE
   ...
   if( !( hb_parc(4) == nullptr ) )
   {
      ...
      if( himage2 != nullptr )
      {
         ...
         if( bm.bmWidth > BtnWidth2 - 4 || bm.bmHeight > height - 5 )
         {
            ...
            if( himage2 == nullptr )
            {
               himage2 = ( HWND ) LoadImage(nullptr, lpImageName2,
