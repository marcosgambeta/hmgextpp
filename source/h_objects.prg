...
METHOD THmgData:Eval(Block)
   ...
   FOR i := 1 TO ::Len()
      IF b
         Eval(Block, hb_HValueAt(::aKey, i), hb_HKeyAt(::aKey, i), i)
      ELSEIF l
         AAdd(a, hb_HValueAt(::aKey, i))
      ELSE
         AAdd(a, {hb_HValueAt(::aKey, i), hb_HKeyAt(::aKey, i), i})
      ENDIF
   NEXT
...
METHOD TWndData:ControlAssign(xValue)
   ...
   IF PCount() == 0
      o := ::GetObj(cMessage)
      IF hb_IsObject(o)
         uRet := _GetValue(NIL, NIL, o:nIndex)
         lError := .F.
      ENDIF
   ELSEIF PCount() == 1
      o := ::GetObj(SubStr(cMessage, 2))
      IF hb_IsObject(o)
         _SetValue(NIL, NIL, xValue, o:nIndex)
         uRet := _GetValue(NIL, NIL, o:nIndex)
         lError := .F.
      ENDIF
   ENDIF
...
///////////////////////////////////////////////////////////////////////////////
   ...
   ACCESS Value INLINE _GetValue(NIL, NIL, ::nIndex)
   ASSIGN Value(xVal) INLINE (_SetValue(NIL, NIL, xVal, ::nIndex), _GetValue(NIL, NIL, ::nIndex))
...
///////////////////////////////////////////////////////////////////////////////
   ...
   ACCESS VarGet INLINE _GetValue(NIL, NIL, ::nIndex)
   ASSIGN VarPut(xVal) INLINE ( _SetValue(NIL, NIL, xVal, ::nIndex), _GetValue(NIL, NIL, ::nIndex) )
...
///////////////////////////////////////////////////////////////////////////////
   ...
   METHOD Action(nItem, bBlock) INLINE _SetStatusItemAction(hb_defaultValue(nItem, 1), bBlock, ::oWin:nHandle)
