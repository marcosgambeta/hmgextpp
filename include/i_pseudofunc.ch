...
#xtranslate PlayBeep() => MessageBeep(0xFFFFFFFF)
#xtranslate PlayAsterisk() => MessageBeep(64)
#xtranslate PlayExclamation() => MessageBeep(48)
#xtranslate PlayHand() => MessageBeep(16)
#xtranslate PlayQuestion() => MessageBeep(32)
#xtranslate PlayOk() => MessageBeep(0)

// ============================================================================

#xtranslate PlayWaveFromResource(<wave>) => C_PlayWave(<wave>, .T., .F., .F., .F., .F.)
#xtranslate _PlayPlayer(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 1)
#xtranslate _StopPlayer(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 2)
#xtranslate _PausePlayer(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 3)
#xtranslate _ClosePlayer(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 4)
#xtranslate _DestroyPlayer(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 5)
#xtranslate _EjectPlayer(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 6)
#xtranslate _SetPlayerPositionEnd(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 7)
#xtranslate _SetPlayerPositionHome(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 8)
#xtranslate _OpenPlayer(<ControlName>, <ParentFormName>, <file>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 9, <file>)
#xtranslate _OpenPlayerDialog(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 10)
#xtranslate _PlayPlayerReverse(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 11)
#xtranslate _ResumePlayer(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 12)
#xtranslate _SetPlayerRepeatOn(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 13, .T.)
#xtranslate _SetPlayerRepeatOff(<ControlName>, <ParentFormName>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 13, .F.)
#xtranslate _SetPlayerSpeed(<ControlName>, <ParentFormName>, <speed>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 14, <speed>)
#xtranslate _SetPlayerVolume(<ControlName>, <ParentFormName>, <volume>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 15, <volume>)
#xtranslate _SetPlayerZoom(<ControlName>, <ParentFormName>, <zoom>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 16, <zoom>)
#xtranslate <x> := _GetPlayerLength(<ControlName>, <ParentFormName>) => <x> := mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 17)
#xtranslate <x> := _GetPlayerPosition(<ControlName>, <ParentFormName>) => <x> := mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 18)
#xtranslate <x> := _GetPlayerVolume(<ControlName>, <ParentFormName>) => <x> := mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 19)
#xtranslate _SetPlayerPosition(<ControlName>, <ParentFormName>, <pos>) => mcifunc(GetControlHandle(<ControlName>, <ParentFormName>), 20, <pos>)

// ============================================================================

#xtranslate _OpenAnimateBox(<ControlName>, <ParentFormName>, <FileName>) => openanimate(GetControlHandle(<ControlName>, <ParentFormName>), <FileName>)
#xtranslate _PlayAnimateBox(<ControlName>, <ParentFormName>) => playanimate(GetControlHandle(<ControlName>, <ParentFormName>))
#xtranslate _SeekAnimateBox(<ControlName>, <ParentFormName>, <Frame>) => seekanimate(GetControlHandle(<ControlName>, <ParentFormName>), <Frame>)
#xtranslate _StopAnimateBox(<ControlName>, <ParentFormName>) => stopanimate(GetControlHandle(<ControlName>, <ParentFormName>))
#xtranslate _CloseAnimateBox(<ControlName>, <ParentFormName>) => closeanimate(GetControlHandle(<ControlName>, <ParentFormName>))
...
#xtranslate RC_CURSOR(<cCursor>) => hmg_SetResCursor(hmg_LoadCursor(GetInstance(), <cCursor>))
