...
#translate <p:Application,App>.Icon.Handle     => hmg_LoadTrayIcon( hmg_GetResources(), _HMG_DefaultIconName, 32, 32 )
...
#translate <p:System,Sys>.ClientRow          => hmg_GetDesktopArea() \[2]
#translate <p:System,Sys>.ClientCol          => hmg_GetDesktopArea() \[1]
